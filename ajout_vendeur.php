<?php
//code qui permet a l'admin d'ajouter un vendeur

//declaration des varibles utiles pour creer un vendeur
...
//MESSAGE D'ERREUR SI CHAMP NON REMPLI
 ...
 if ($erreur == "") 
 {
     ...
     $db_found = mysqli_select_db($db_handle, $database);
           if (isset($_POST["buttonajoutervendeur"])) 
           {
                if ($db_found) 
                {
                  //ON SELECTIONNE DANS LA BDD
                     $sql = "SELECT * FROM personne P, vendeur V";

                     if ($email != "") 
                     {
                        //SI PAS DERREUR DE SAISIS
