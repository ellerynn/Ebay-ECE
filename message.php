<?php
	...
	$ID_temporaire_acheteur = 2; //test sinon faut mettre 29, jai mis 2 pour desctiver la boucle decriture
	...
	if (isset($_POST["buttonenvoyer"])) 
	{
        ...
        if ($erreur == "") 
        {
        	if ($db_found) 
            {	
            	if($ID_temporaire_acheteur == 29)
            	{
            		$sql = "INSERT INTO contact(ID_admin, ID_acheteur, Message, Objet) VALUES ('3','$ID_temporaire_acheteur','$message','$objet');";
                	$result = mysqli_query($db_handle, $sql);
            	}
            	if($ID_temporaire_admin == 3)
            	{
            		$sql = "INSERT INTO contact(ID_admin, ID_acheteur, Message, Reponse, Objet) VALUES ('$ID_temporaire_admin','29','$message','1','$objet');";
                	$result = mysqli_query($db_handle, $sql);
                	$sql1 = "UPDATE contact SET Reponse = '1' WHERE ID_admin = '29' AND ID_acheteur = '29' AND Reponse = '0' ;";
			    ...
			    <div class="col-lg-9 col-md-9 col-sm-12" style="position: relative; height: 800px;">
			    	<div class="panel border" style="padding: 1em; border-radius: 5px;" id="panel_vendre">
					    <div class="panel-heading">
					    	<br><h2 class="text-center">Votre message</h2><br>
					    </div>
